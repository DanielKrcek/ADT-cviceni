...
class SudokuSolver:
    ...
    def check_sequence(self, sequence: np.ndarray) -> bool:
        sequence_non_zero = sequence[sequence != 0] ## 27:00
    ...
    def check_block(self, row_index: int, column_index: int) -> bool:
        ...
        return self.check_sequence(self.field[row_start_index : row_start_index + 3, column_start_index:column_start_index+3].reshape(-1))   # noqa: E501

    def check_one_cell(self, row_index: int , column_index: int) -> bool:
        return self.check_row(row_index) and self.check_column(column_index) and self.check_block(row_index, column_index)  # noqa: E501
